...
import { articleCategories, ArticleCategory, Article } from "@/types";
...
export function ArticlePage({ articles, featured }: Props) {
          ...
          <motion.div variants={fadeInUp} className="mb-12 lg:mb-16">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10">
              ...
              <p className="text-primary/80 text-sm tracking-widest uppercase">
                {gridArticles.length} Article
                {gridArticles.length !== 1 ? "s" : ""}
              </p>
            </div>
