...
import { ReviewItem } from "@/hook/useReviews";
...
export function PortfolioPage({
  ...
  const filteredItems = useMemo(() => {
    ...
    if (selectedExperience !== "all") {
      list = list.filter((item) => item.experience_id === selectedExperience);
    }
    if (selectedDestination !== "all") {
      list = list.filter((item) => item.destination_id === selectedDestination);
    }
    return list;
  }, [portfolios, selectedExperience, selectedDestination]);
