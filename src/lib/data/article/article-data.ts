...
export const articles: Article[] = [
  // ─── Guides ──────────────────────────────────────────────────────────────────
  {
    ...
    excerpt:
      "From setting your timeline to understanding legal requirements, this guide walks international couples through every stage of planning a destination wedding in Bali.",
    publishedAt: "2024-11-12",
    image: "https://placehold.net/default.svg",
    content: `<h2>Where to Begin</h2><p>Planning a destination wedding in Bali requires a different kind of thinking than planning at home. The distances involved, the vendor relationships, the legal landscape, and the guest logistics all demand earlier decisions and a clearer picture of what you want before the first booking is made.</p><p>This guide covers everything from initial timeline setting to the final details that make a Bali destination wedding feel truly intentional.</p><h2>Setting Your Timeline</h2><p>Most couples underestimate how far in advance a destination wedding in Bali requires planning. A realistic minimum is twelve to fourteen months, and for weddings during peak season — July, August, and December — eighteen months is often necessary to secure the venue and vendors you want.</p><blockquote><p>The couples who feel most at ease on their wedding day are invariably those who gave themselves the gift of time in the planning phase.</p></blockquote><h2>Understanding the Legal Requirements</h2><p>For international couples, a legal marriage ceremony in Bali requires specific documentation and must be conducted through a recognised officiating body. Many couples choose to handle their legal paperwork at home and treat their Bali ceremony as a symbolic celebration — allowing full creative freedom without administrative constraints.</p><h2>Building Your Vendor Team</h2><p>A destination wedding in Bali requires a team of local specialists who understand the environment, the logistics, and the culture. Your wedding planner is your most important relationship — they become your local representative, your problem-solver, and your creative partner throughout the process.</p>`,
  },
  {
    id: 2,
  ...
  {
    id: 11,
    slug: "real-wedding-sarah-james-ubud-elopement",
    category: "Real Weddings",
    tag: "Real Weddings",
    title: "A Jungle Elopement in Ubud: Sarah & James",
    excerpt:
      "Two people, a river valley, and a ceremony designed to exist only for that morning. The story of how Sarah and James chose to elope in the jungles of Ubud.",
    publishedAt: "2024-05-20",
    image: "https://placehold.net/default.svg",
    content: `<h2>The Decision to Elope</h2><p>Sarah and James had been engaged for eight months before they admitted something to each other: neither of them wanted a large wedding. What they wanted was a ceremony that felt true — for two people, in a place that moved them, designed with the same care as any larger celebration but distilled to its essential meaning.</p><h2>Why Ubud</h2><p>They had visited Ubud together two years before. The river valley beneath the rice terraces — the sound of water, the quality of the morning light, the layered greens of the jungle canopy — had stayed with them. When they began to imagine their ceremony, Ubud was the only landscape that came to mind.</p><blockquote><p>"We didn't want to explain it to anyone. We just wanted to be there, in that valley, on that morning."</p></blockquote><h2>The Ceremony</h2><p>The ceremony took place at dawn, in a clearing above the river, reached by a short walk through the jungle. There were flowers — white, pale green, and deep tropical red — arranged as if they had grown there. Their vows were their own words. The light came through the canopy in long, slow columns. It lasted forty minutes.</p><h2>What They Said Afterwards</h2><p>Sarah later wrote: it was the most honest thing we have ever done together. James said simply: it was ours.</p>`,
  },
  {
    id: 12,
    slug: "real-wedding-anna-marco-uluwatu",
    category: "Real Weddings",
    tag: "Real Weddings",
    title: "An Intimate Clifftop Celebration in Uluwatu: Anna & Marco",
    excerpt:
      "Thirty guests, an ocean horizon, and a reception that moved between candlelight and open sky. The story of how Anna and Marco celebrated in Bali's south.",
    publishedAt: "2024-05-06",
    image: "https://placehold.net/default.svg",
    content: `<h2>Thirty People, One Clifftop</h2><p>Anna and Marco's brief was simple but precise: intimate, beautiful, and with the ocean in every frame. They had thirty guests — close family and their most important friends — who they wanted to gather in a setting that would feel genuinely extraordinary without being performative.</p><h2>The Setting</h2><p>They chose a private clifftop estate in Uluwatu — a property that sits sixty metres above the Indian Ocean, with a ceremony terrace carved into the cliff itself. The view is uninterrupted in every direction. At golden hour, the light turns everything amber.</p><blockquote><p>When thirty people stand together on a cliff above the Indian Ocean and the light does what it does in Uluwatu, something happens that is difficult to describe and impossible to forget.</p></blockquote><h2>The Reception</h2><p>Dinner was held on the lawn above the cliff, beneath a canopy of paper lanterns and tropical botanicals. The table was long and dressed in white linen. As the evening progressed and the candles came into their own, the ocean disappeared into darkness below — and the table became the entire world.</p>`,
  },
